...
- extensions/things-tasks/guides/gtd.md: Task management for both Bud and the owner via Things 3 (things_* tools)
- extensions/things-tasks/guides/things-mcp.md: Things 3 integration for both Bud and user tasks
